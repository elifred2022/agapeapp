...
const ListaDescuento = ({ almacenPorcentEfectivo, arregloAlmacenPorcentajeEfectivo, eliminarPorcentaje }) => {
        ...
        <tbody>
              ...
              {almacenPorcentEfectivo.map((elem, index) => (
                <tr key={index} >
                  ...
                  <td><button className='my-button_eliminar' onClick={() => eliminarPorcentaje(index)}><IoMdTrash /></button></td>
                 </tr>
              ))}
